...
class OnlineCheckout(models.Model):
    ...
    for_order = models.ForeignKey(Order, related_name='order', verbose_name=_("Which Order"), null=True, on_delete=models.SET_NULL)
...
class OnlineCheckoutResponse(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "STK Push Responses"
