# Generated by Django 3.2.7 on 2021-12-12 09:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('for_order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order', to='ecomapp.order', verbose_name='Which Order')),
            ],
            options={
